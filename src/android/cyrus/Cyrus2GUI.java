...
public class Cyrus2GUI {
    ...
    private void addObjectToSubs(String parentuid, String p, String pp, LinkedList subone, LinkedList subtwo, float tx, float ty, float tz){
        ...
        position.add(tx+getFloatFromList(subposn,0,0));
        position.add(ty+getFloatFromList(subposn,1,0));
        position.add(tz+getFloatFromList(subposn,2,0));
    ...
    private LinkedHashMap object2mesh(String p, boolean shallow){
        if(user.contentIsThisUID(p,user.uid)) return null;
